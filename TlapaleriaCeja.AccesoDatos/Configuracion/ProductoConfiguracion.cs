...
namespace TlapaleriaCeja.AccesoDatos.Configuracion
{
    public class ProductoConfiguracion : IEntityTypeConfiguration<Producto>
    {
        public void Configure(EntityTypeBuilder<Producto> builder)
        {
            ...
            builder.Property(x => x.SKU).IsRequired().HasMaxLength(12);
            builder.Property(x => x.NumeroSerie).IsRequired(false).HasMaxLength(30);
            builder.Property(x => x.Descripcion).IsRequired().HasMaxLength(100);
            builder.Property(x => x.Precio).IsRequired().HasColumnType("decimal(18, 2)");
            builder.Property(x => x.Costo).IsRequired().HasColumnType("decimal(18, 2)");
